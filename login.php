<?php
// core configuration
include_once "php-login-script-level-1/config/core.php";
...
$require_login=false;
include_once "php-login-script-level-1/login_checker.php";
...
if($_POST){
        // include classes
    include_once "php-login-script-level-1/config/database.php";
    ...
    $email_exists = $user->emailExists();
        ...
        // validate login
    if ($email_exists && password_verify($_POST['uPass'], $user->uPass) && $user->status==1){
    ...
    echo "<div class='account-wall'>";
        echo "<div id='my-tab-content' class='tab-content'>";
            echo "<div class='tab-pane active' id='login'>";
                echo "<img class='profile-img' src='img/login_icon.png'>";
